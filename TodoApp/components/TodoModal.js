...
class TodoModal extends React.Component {
  ...
  toggleFindModal() {
    this.setState({ findVisible: !this.state.findVisible });
  }
    ...
    return (
      <View style={styles.container}>
        <Modal
          ...
          onRequestClose={() => this.toggleFindoModal()}
        >
          <FindModal
            list={list}
            closeModal={() => this.toggleFindModal()}
            updateList={this.props.updateList}
            goHome={(() => this.toggleFindModal, this.props.closeModal)}
          />
        </Modal>
        ...
        <View style={styles.footer}>
          <TouchableOpacity style={styles.cart} onPress={this.props.closeModal}>
            <Ionicons name="home" size={40} color={colors.white} />
          </TouchableOpacity>
          <TouchableOpacity
            style={styles.profile}
            onPress={() => this.toggleFindModal()}
          >
